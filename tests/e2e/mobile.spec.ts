...
test.describe('Mobile', () => {
  ...
  test('mobile menu has navigation links', async ({ page }) => {
    await page.goto('/');
    await page.locator('#mobile-menu-open').click();
    await expect(page.locator('#mobile-menu').getByText('Recipes')).toBeVisible();
    await expect(page.locator('#mobile-menu').getByText('Categories')).toBeVisible();
    await expect(page.locator('#mobile-menu').getByText('About')).toBeVisible();
  });
